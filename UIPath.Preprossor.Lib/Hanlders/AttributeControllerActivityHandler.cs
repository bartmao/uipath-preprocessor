...
namespace UIPath.Preprossor.Lib
{
    public class AttributeControllerActivityHandler : TypedActivityHandler
    {
        ...
        {
            if (RegexFilter == "@StartWorkflow") return WorkContext.IsMainActivity && WorkContext.IsStartWorflow;
            else if (RegexFilter == "@MainActivity") return WorkContext.IsMainActivity;
            return base.Test();
        }
